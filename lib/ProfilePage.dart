...
import 'package:fwf/pages/UpdateProfile.dart';
...
class SettingsOnePage extends StatefulWidget {
  ...
  final String email;
  // final String number;
  SettingsOnePage({Key key, @required this.uid,this.image,this.name,this.email}) : super(key: key);
...
String email ='';
  _fetchData() async {
    ...
    if (pref.getString("email") != null) {
      ...
      final url =
          "http://adfifmedia.org/getprofile.php?ID=${get}";
                ...
                children: <Widget>[
                  Card(
                    ...
                    child: ListTile(
                      ...
                      trailing: InkWell(
                        onTap: ()=>{
                        Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => UpdateProfile(idUser: email,)))
                        },
                        child: Icon(
                          Icons.edit,
                          color: Colors.white,
