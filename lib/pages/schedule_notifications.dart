...
//
  ...
  Future<bool> init({
    ...
    try {
      ...
      var initializationSettings = InitializationSettings(
          android: AndroidInitializationSettings(_appIcon), iOS: initializationSettingsIOS);
  ...
  NotificationDetails _notificationDetails(
    ...
    try {
      ...
      notificationSpecifics = NotificationDetails(android: androidSettings, iOS: iOSSettings);
    } catch (ex) {
